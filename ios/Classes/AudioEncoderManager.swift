...
class AudioEncoderManager {
    ...
    private let encodingQueue = DispatchQueue(label: "com.flutterdictation.audioEncoder")
    private let writerQueue = DispatchQueue(label: "com.flutterdictation.audioEncoder.writer")
    ...
    private func transcodeToCanonical(
        ...
        // Process samples
        let processingQueue = DispatchQueue(label: "com.flutterdictation.transcode")
        let semaphore = DispatchSemaphore(value: 0)
